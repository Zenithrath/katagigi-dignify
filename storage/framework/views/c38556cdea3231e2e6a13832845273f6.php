...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> <?php echo e(__('general.schedule.index.title')); ?> <?php $__env->endSlot(); ?>

    <main class="main-table-container" x-data="scheduleLookup">
        <section class="heading">
            <div>
                <h1><?php echo e(__('general.schedule.index.title')); ?></h1>
                <p><?php echo e(__('general.schedule.index.subtitle')); ?></p>
            </div>
        </section>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('role', 'admin|nurse')): ?>
            <div class="content-card">
                <div class="card-header-clean">
                    ...
                    <h2><?php echo e(__('general.schedule.form.title._title')); ?></h2>
                </div>

                <form method="post" action="<?php echo e(route('schedules.store')); ?>" x-data="{ processing: false, doctorOpen: false, doctorValue: '<?php echo e(old('doctor_id')); ?>', dayOpen: false, dayValue: '<?php echo e(old('day')); ?>' }" @submit="processing = true">
                    <?php echo csrf_field(); ?>
                    <div class="form-grid">
                        ...
                        <div class="input-wrapper col-4">
                            <label>
                                ...
                                <?php echo e(__('general.schedule.form.labels.doctor._title')); ?>
                            ...
                            <div @click.away="doctorOpen = false" style="position: relative;">
                                <button type="button" @click="doctorOpen = !doctorOpen"
                                    ...
                                    <span x-text="doctorValue ? document.querySelector(`[data-doctor-val='${doctorValue}']`)?.textContent || '<?php echo e(__('general.schedule.form.labels.doctor.default')); ?>' : '<?php echo e(__('general.schedule.form.labels.doctor.default')); ?>'"></span>
                                ...
                                <div x-show="doctorOpen" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
                                    ...
                                    <div class="dropdown-item is-placeholder" x-text="'<?php echo e(__('general.schedule.form.labels.doctor.default')); ?>'"></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($doctorList) == 0): ?>
                                        <div class="dropdown-item is-empty-state"><?php echo e(__('general.schedule.form.labels.doctor.empty')); ?></div>
                                    <?php else: ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $doctorList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="dropdown-item" :class="doctorValue === '<?php echo e($doctor->id); ?>' ? 'is-selected' : ''"
                                                data-doctor-val="<?php echo e($doctor->id); ?>"
                                                @click="doctorValue = '<?php echo e($doctor->id); ?>'; doctorOpen = false"><?php echo e($doctor->name); ?></div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create schedule')): ?>
                            ...
                            <div class="input-wrapper col-3">
                                <label>
                                    ...
                                    <?php echo e(__('general.schedule.form.labels.day._title')); ?>
                                ...
                                <div @click.away="dayOpen = false" style="position: relative;">
                                    <button type="button" @click="dayOpen = !dayOpen"
                                        ...
                                        <span x-text="dayValue ? document.querySelector(`[data-day-val='${dayValue}']`)?.textContent || '<?php echo e(__('general.schedule.form.labels.day.default')); ?>' : '<?php echo e(__('general.schedule.form.labels.day.default')); ?>'"></span>
                                    ...
                                    <div x-show="dayOpen" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
                                        class="dropdown-panel">
                                        <div class="dropdown-item is-placeholder" x-text="'<?php echo e(__('general.schedule.form.labels.day.default')); ?>'"></div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['MONDAY' => 'monday', 'TUESDAY' => 'tuesday', 'WEDNESDAY' => 'wednesday', 'THURSDAY' => 'thursday', 'FRIDAY' => 'friday', 'SATURDAY' => 'saturday', 'SUNDAY' => 'sunday']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="dropdown-item" :class="dayValue === '<?php echo e($value); ?>' ? 'is-selected' : ''"
                                                data-day-val="<?php echo e($value); ?>"
                                                @click="dayValue = '<?php echo e($value); ?>'; dayOpen = false"><?php echo e(__('general.schedule.form.labels.day.' . $key)); ?></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="input-wrapper col-2">
                                <label for="start_time">
                                    ...
                                    <?php echo e(__('general.schedule.form.labels.start_time')); ?>

                                </label>
                                <input type="time" name="start_time" id="start_time" class="custom-input" required value="<?php echo e(old('start_time')); ?>" />
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="input-wrapper col-2">
                                <label for="end_time">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                                    <?php echo e(__('general.schedule.form.labels.end_time')); ?>

                                </label>
                                <input type="time" name="end_time" id="end_time" class="custom-input" required value="<?php echo e(old('end_time')); ?>" />
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn-submit" :disabled="processing">
                                    ...
                                    <span x-show="!processing"><?php echo e(__('general.schedule.form.buttons.add')); ?></span>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div x-data="{ open: false }" @click.away="open = false" class="relative" style="min-width: 180px;">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $doctorList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="dropdown-item text-[13px] py-2 px-3.5" :class="filterDoctorId === '<?php echo e($doctor->id); ?>' ? 'is-selected' : ''"
                                        data-value="<?php echo e($doctor->id); ?>"
                                        @click="filterDoctorId = '<?php echo e($doctor->id); ?>'; pagination.page = 1; lookup(); open = false"><?php echo e($doctor->name); ?></div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                    </div>
                            ...
                            <template x-if="!isLoading && scheduleList.length === 0">
                                <tr><td colspan="6" class="text-center py-12">
                                    <div class="flex flex-col items-center gap-2 text-slate-400">
                                        ...
                                        <span class="text-sm"><?php echo e(__('general.schedule.index.table.empty')); ?></span>
                                    </div>
                                </td></tr>
                            </template>
                            <template x-if="!isLoading && scheduleList.length > 0">
                                        ...
                                        <td class="action-column">
                                            <div class="flex items-center justify-end gap-1">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update schedule')): ?>
                                                    <form
                                                        :action="`<?php echo e(route('schedules.update_status', ['schedule' => '__ID__'])); ?>`.replace('__ID__', schedule.id)"
                                                        method="post"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete schedule')): ?>
                                                    <form
                                                        :action="`<?php echo e(route('schedules.destroy', ['schedule' => '__ID__'])); ?>`.replace('__ID__', schedule.id)"
                                                        method="post"
...
<?php if (! $__env->hasRenderedOnce('4aa78ef7-1ce0-4737-a605-71f328ea612e')): $__env->markAsRenderedOnce('4aa78ef7-1ce0-4737-a605-71f328ea612e');
        ...
        const scheduleLookup = {
            ...
            lookup() {
                ...
                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'admin|nurse')): ?>
                    fetch(`<?php echo e(route('api.schedules.lookup')); ?>?${params}`)
                ...
                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'doctor')): ?>
                    fetch(`<?php echo e(route('api.schedules.lookup.doctor')); ?>?${params}`)
                        .then(response => response.json())
                        .then(data => {
                            this.scheduleList = data.data;
                            this.pagination = {
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\katagigi-dignify\resources\views/pages/general/schedule/index.blade.php ENDPATH**/ ?>