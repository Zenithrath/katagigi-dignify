                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        <button type="button" @click="setMode('revenue')"
                            :class="mode === 'revenue' ? 'bg-emerald-700 text-white hover:bg-emerald-600' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'"
                            class="py-2 px-4 rounded-xl ease-in duration-150 text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-700">Rupiah</button>
                        <button type="button" @click="setMode('visits')"
                            :class="mode === 'visits' ? 'bg-emerald-700 text-white hover:bg-emerald-600' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'"
                            class="py-2 px-4 rounded-xl ease-in duration-150 text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-700">Kunjungan</button>
                    </div>

                    {{-- Dropdown periode --}}
                    <div class="bg-slate-100 ease-in duration-150 hover:bg-slate-200 pb-2 pt-1 px-3 rounded-xl">
                        <label for="chart-revenue-period" class="sr-only">Pilih Periode</label>
                        <select id="chart-revenue-period" x-model="period" aria-label="Pilih periode" class="text-xs font-semibold text-slate-600 bg-transparent focus:outline-none cursor-pointer">
