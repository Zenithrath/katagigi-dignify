...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['data', 'type' => 'create']));
...
foreach (array_filter((['data', 'type' => 'create']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="input-group !mb-0 p-8 pb-2" x-data="pictureState(<?php echo e(($data->profile_picture ?? null) ? 'true' : 'false'); ?>)">
    <div class="flex items-center gap-5">
        ...
        <div class="relative w-24 h-24 rounded-xl border-2 border-dashed border-slate-300 bg-slate-50 overflow-hidden flex-shrink-0 group hover:border-emerald-400 hover:bg-emerald-50/30 transition-all">
            <img id="profile-preview" x-show="isProfilePreviewMode" x-cloak
                src="<?php echo e($type == 'update' && isset($data->profile_picture) ? url('storage/' . $data->profile_picture) : ''); ?>"
...
<?php $component->withName('lucide-camera'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-7 h-7 text-slate-300']); ?>
...
<?php /**PATH C:\laragon\www\katagigi-dignify\resources\views/components/picture-upload.blade.php ENDPATH**/ ?>